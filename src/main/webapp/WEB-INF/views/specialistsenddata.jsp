...
<body ng-App="myApp" class="ng-cloak" background="static/images/bg-specialist.jpeg">
	<div align="center">
	<div align="center" class="generic-container" ng-controller="UserDetailsController as ctrl" data-ng-init="init('specialistsend')">
	<div class="panel panel-default">
		<div class="panel-heading floatCenter" align="center">
			<span class="lead"> Client Details Form </span>
		</div>
		<div class="formcontainer">
			<form ng-submit="ctrl.submit('specialistsend')" name="specialistSendForm" class="form-horizontal">
			...
			<br>
				<div class="row">
					<div class="form-group col-md-12">
						<label align="right" class="col-md-4 control-lable" for="file">Specialist Name  : {{ ctrl.user.userName }}  </label>
						<label align="left" class="col-md-4 control-lable" for="file"> Doctor Name : {{ ctrl.doctorName}}  </label>
						<label align="left" class="col-md-4 control-lable" for="file"> Patient Name : {{ ctrl.patient.userName}}  </label>						
					</div>
				</div>
				...
				<div>
					...
					<table align="center">
						<tr>	
							<td> 
								<input id="sendDoctor" type="submit" value="Send To Doctor" class="btn btn-success btn-sm" />
							</td>
							<td> &nbsp; </td>
