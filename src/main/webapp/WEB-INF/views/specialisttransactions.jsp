...
<body ng-App="myApp" class="ng-cloak" background="static/images/bg-doctor.jpeg">
	<div align="center">
	<div align="center" class="generic-container" ng-controller="UserDetailsController as ctrl" data-ng-init="init('specialisttransaction')">
	<div class="panel panel-default">
		<div class="panel-heading floatCenter" align="center">
			<span class="lead"> Specialist Transactions Form </span>
		</div>
		<div class="floatCenter labelHeader">
			<a href="doctortransactions">Doctor Transactions </a> &nbsp; &nbsp;&nbsp; &nbsp;  
			<a href="doctorclienttransactions">Patient Transactions</a>&nbsp;&nbsp;&nbsp;&nbsp;  
			<a href="#">Specialist Transactions</a> 
		</div>	
			...
			<div ng-if="errorMessage" style="color:red;font-weight: bold;">{{ errorMessage }}</div>
                ...
                <div class="row">
					<div class="form-group col-md-12">
						<label align="right" class="col-md-4 control-lable" for="file">Doctor Name  : {{ ctrl.user.userName }}  </label>
						<label align="left"  class="col-md-4 control-lable" for="file"> Patient Name : {{ ctrl.patient.userName }}  </label>
						<!-- <label align="left"  class="col-md-4 control-lable" for="file"> Specialist Name : {{ ctrl.patient.userName }}  </label>  -->
					</div>
				</div>
