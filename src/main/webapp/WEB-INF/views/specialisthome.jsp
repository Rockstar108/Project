...
<body ng-App="myApp" class="ng-cloak" background="static/images/bg-specialist.jpeg">
	<div align="center">
	<div align="center" class="generic-container" ng-controller="UserDetailsController as ctrl" data-ng-init="init('specialisthome')">
	<div class="panel panel-default">
		<div class="panel-heading floatCenter" align="center">
			<span class="lead"> Specialist Details Form </span>
		</div>
		<div class="formcontainer">
			<form name="specialistForm" class="form-horizontal">
			<div ng-if="errorMessage" style="color:red;font-weight: bold;">{{ errorMessage }}</div>
				<br>
				
				<div class="row">
                    <div class="form-group col-md-12">
                        <label align="right" class="col-md-2 control-lable" for="file">Specialist Name</label>
				...
				<div id="patientDetails" style="visibility: hidden">
					<table border="1px solid grey"  background-color="#FFA500" ng-table="ctrl.tableParams2" class="table">
	    				<tr ng-repeat="user in $data">
	            			...
	            			<td title="'State'">
	            					{{user.state}} </td>
	            			<td title="'Doctor Name'">
	            					{{user.doctorName}} </td>
	            				            			<td title="'Transactions'" align="center">
	            				<a ng-click="ctrl.displaySendSpecialist(user)"><img src="static/images/details.png" height="20" width="20"/> </a> </td>
