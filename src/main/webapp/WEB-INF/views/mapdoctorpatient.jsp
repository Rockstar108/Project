	...
	<div align="center" class="generic-container" ng-controller="UserDetailsController as ctrl" data-ng-init="init('mappatients')">
		<div class="panel panel-default">
			<div class="panel-heading">
				<span class="lead"> Map Doctor - Patient Details </span>
			</div>
			<div class="floatCenter labelHeader ">
			    <a href="adminhome">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    <a href="#">Map Patients</a>
			</div>
			<div class="formcontainer">
				<form ng-submit="ctrl.submit('mappatients')" name="mapPatientForm" class="form-horizontal">
					...
					<div class="form-group col-md-12">
						<label align="right" class="col-md-4 control-lable" for="file">Doctor Name</label>
						<div class="col-md-5">
							<select class="roleId form-control input-sm" ng-model="ctrl.user.userId" ng-change="ctrl.fetchPatientMappedToDoctor()"
