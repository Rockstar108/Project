...
<body ng-app="myApp" class="ng-cloak" onload="">
	<div align="center">
	<div align="center" class="generic-container" ng-controller="UserController as ctrl"  data-ng-init="init('edituser')">
	<div class="panel panel-default" >
		<div class="panel-heading floatCenter" align="center">
			<span class="lead"> Edit User Details Form </span>
		</div>
		<div class="formcontainer center_div">
			<form name="editUserForm" ng-submit="ctrl.submit('edituser')" class="form-horizontal">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-6">
							<input type="date" ng-model="ctrl.user.dateOfBirth" name="dateOfBirth"
								...
								placeholder="Enter your Date of Birth" required readonly />
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						...
						<div class="col-md-6">
							<input type="text" ng-model="ctrl.user.phoneNumber"
								name="phoneNumber" class="phoneNumber form-control input-sm"
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-6">
							<input type="text" ng-model="ctrl.user.mobileNumber"
								name="mobileNumber" class="mobileNumber form-control input-sm"
				...
				<div class="row">
					<div class="form-group col-md-12">
						...
						<div class="col-md-6">
							<input type="password" name="retype-password" class="retype-password form-control input-sm"
				...
				<div class="row">
					<div class="form-actions " align="center">
						...
						<button type="button" class="btn btn-warning btn-sm" ng-click="ctrl.reset()" ng-disabled="edituserForm.$pristine">Reset Form</button>
