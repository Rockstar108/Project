...
@Repository
public class AWSUserTransactionDetailsDAOImpl implements AWSUserTransactionDetailsDAO {

	private Logger logger = Logger.getLogger(AWSUserTransactionDetailsDAOImpl.class);
	...
	public void sendDetailsToPatient(String patientName, String userName, String subject, String description,
		...
		jdbcTemplate.update(INSERT_TRANSACTION_DETAILS, patientName, "DOCTOR_TO_PATIENT", subject, description,
				publicKey, userName, createdDateTime);
	}
	...
	public void sendDetailsToDoctor(String doctorName, String userName, String subject, String description) {
		...
		String createdDateTime = CommonsUtility.getCurrentDateTime();
		jdbcTemplate.update(INSERT_TRANSACTION_DETAILS, doctorName, "PATIENT_TO_DOCTOR", subject, description, null,
				userName, createdDateTime);
	}

	@Override
	public void sendSpecialistDetailsToDoctor(String doctorName, String specialistName, String patientName,
			String subject, String description, byte[] publicKey) {
		logger.debug("UserTransactionDetailsDAOimpl :: sendSpecialistDetailsToDoctor :: STARTS ");
		String createdDateTime = CommonsUtility.getCurrentDateTime();
		jdbcTemplate.update(INSERT_SPECIALIST_TRANSACTION_DETAILS, doctorName, "SPECIALIST_TO_DOCTOR", subject,
				description, null, specialistName, createdDateTime, patientName);
	}
	...
	public List<UserTransactionDetails> getUserTransactionDetails(String userName) {
		...
		List<UserTransactionDetails> transactionList = jdbcTemplate.query(SELECT_TRANSACTION_DETAILS,
	...
	public List<UserTransactionDetails> getClientTransactionDetails(String userName, String patientName) {
		...
		List<UserTransactionDetails> transactionList = jdbcTemplate.query(SELECT_CLIENT_TRANSACTION_DETAILS,
				new Object[] { userName, patientName }, new RowMapper() {
	...
	public List<UserTransactionDetails> getSpecialistTransactionDetails(String userName, String patientName) {
		logger.info("UserTransactionDetailsDAOImpl :: getClientTransactionDetails :: STARTS ");
		List<UserTransactionDetails> transactionList = jdbcTemplate.query(SELECT_SPECIALIST_TRANSACTION_DETAILS,
				new Object[] { userName, patientName }, new RowMapper() {
	...
	public String getPublicKeyByTransactionId(String transactionId) {
		...
		String publicKey = (String) jdbcTemplate.queryForObject(GET_PUBLICKEY_BYTRASACTION_ID,
